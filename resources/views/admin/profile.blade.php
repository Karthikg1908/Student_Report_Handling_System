						...
						<div class="col-md-4 col-xl-3">
							<div class="card mb-3">
								...
								<div class="card-body text-center">
                                    ...
                                    <img src="../images/admin/{{Auth::user()->profilePicture}}" alt="profilePic"
										class="img-fluid rounded-circle mb-2" width="128" height="128" />
                                    @else
									<img src="../img/logo.png" alt="profilePic"
										class="img-fluid rounded-circle mb-2" width="128" height="128" />
                                    @endif
									<h3 class="mb-0" style="color: black;">Admin Name</h3>
									<div class="text-muted mb-2">Admin</div>
									<form action="/admin/profileUpdate" method="post" enctype="multipart/form-data">
                                        @csrf
