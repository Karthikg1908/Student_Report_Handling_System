...
<body>
    ...
    @include("admin.fileUpload")
            ...
            @foreach ($getStudents as $data)
            <form action="/admin/addstudents-details" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" name="academicYear" id="year">
                                                <option value="1st Year">First Year</option>
                                                <option value="2nd Year">Second Year</option>
                                                <option value="3rd year">Third Year</option>
                                              </select></td>
                                        <td><select class="form-control" name="academicSemesters" id="sem">
