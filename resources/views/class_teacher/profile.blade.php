							...
							<div class="card mb-3">
								...
								<div class="card-body text-center">
									...
									<img src="../img/avatars/avatar-4.jpg" alt="Christina Mason"
                                        ...
                                        @else
                                        <img src="../images/teachers/{{ Auth::user()->profilePicture }}" alt="Christina Mason"
										class="img-fluid rounded-circle mb-2" width="128" height="128" />
                                        @endif
									<h3 class="mb-0" style="color: black;">{{ Auth::user()->name }}</h3>
									<div class="text-muted mb-2">Class Teacher</div>
									<form action="/class-teacher/profileUpdate" method="post" enctype="multipart/form-data">
                                        @csrf
