    ...
    <div class="navbar-collapse collapse">
        <ul class="navbar-nav navbar-align">
            <li class="nav-item dropdown">
                ...
                <img src="../images/teachers/{{Auth::user()->profilePicture}}" class="avatar img-fluid rounded mr-1"
                    alt="profile pic" />
                @else
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" href="/class-teacher/profile"><i class="align-middle mr-1"
